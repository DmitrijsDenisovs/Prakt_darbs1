...
<body>
    ...
    <div class = "form-container container border">
        <form action="changePassword.php" autocomplete="off" method="POST">
            <?php
            ...
            ?>        
            <label for="passowrd">Jaunā parole</label>
            ...
            <br>
            <button class = "my-2 btn-primary" type = "submit">Mainīt paroli</button>
        </form>
